...
# O programa, então, verifica se a identificação informada pelo usuário está na lista ['kaio', 'paola', ' felipe', 'gustavo' ] de usuários válidos.
